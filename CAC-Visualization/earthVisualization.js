...
function initializeEarthCanvas() {
    ...
    descriptionContainer.style('left', '20px');
    descriptionContainer.style('top', '100px'); // Kept position of the text bubble unchanged
    ...
    canvasContainer.style('margin', '10px auto 0 auto');
    canvasContainer.style('position', 'absolute');
    canvasContainer.style('left', '20px');
    canvasContainer.style('top', '220px'); // Further reduced gap between the text bubble and canvas
