...
function createFullViewportContainer(parent, id = 'simulation-container') {
  ...
  // Fill entire viewport minus title height.
  ...
  // Set relative positioning so children can use absolute positioning if needed.
...
function initCanvas() {
  ...
  // Set simulation canvas’s position and a low z-index.
